...
Shader "Custom/MagicCarpet"
{
    Properties
    {
        ...
        _NoiseBumpY("Noise Bump Y", Range(0, 2)) = 0.05
    ...
    SubShader
    {
        ...
        #pragma surface surf Standard fullforwardshadows vertex:vert tessellate:tessEdge tessphong:_Phong addshadow
