...
public class InputBinding
{
    ...
    ***********************************************************************/
    ...
    {
        Bind(UserAction.MouseLeft, KeyCode.Mouse0);
        Bind(UserAction.MouseRight, KeyCode.Mouse1);
        Bind(UserAction.MouseMiddle, KeyCode.Mouse2);
        ...
        Bind(UserAction.Dodge, KeyCode.LeftShift);
        Bind(UserAction.Jump, KeyCode.Space);

        Bind(UserAction.Quick1, KeyCode.Alpha1);
        Bind(UserAction.Quick2, KeyCode.Alpha2);
        Bind(UserAction.Quick3, KeyCode.Alpha3);
        Bind(UserAction.Quick4, KeyCode.Alpha4);
        Bind(UserAction.Quick5, KeyCode.Alpha5);
        Bind(UserAction.Quick6, KeyCode.Alpha6);
        Bind(UserAction.Quick7, KeyCode.Alpha7);
        Bind(UserAction.Quick8, KeyCode.Alpha8);
        Bind(UserAction.Quick9, KeyCode.Alpha9);
        Bind(UserAction.Quick0, KeyCode.Alpha0);

        Bind(UserAction.SubQuick1, KeyCode.Q);
        Bind(UserAction.SubQuick2, KeyCode.E);
        Bind(UserAction.SubQuick3, KeyCode.R);
        Bind(UserAction.SubQuick4, KeyCode.F);

        Bind(UserAction.Toggle_ChangeBehaviorMode, KeyCode.Tab);
        Bind(UserAction.Toggle_ShowCursor, KeyCode.LeftAlt);
        Bind(UserAction.Toggle_ChangeCameraView, KeyCode.BackQuote);

        Bind(UserAction.ShowToolSet, KeyCode.V);

        Bind(UserAction.UI_EquipAndStat, KeyCode.U);
        Bind(UserAction.UI_Inventory, KeyCode.I);
        Bind(UserAction.UI_Skill, KeyCode.K);
        Bind(UserAction.UI_Emotion, KeyCode.F1);

        Bind(UserAction.Temp_RideOnVehicle, KeyCode.G);
    }
